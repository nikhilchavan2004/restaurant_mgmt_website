...
const Qualities = () => {
        ...
        testimonials: [
          {
            ...
            image: "./review1.png",
            description:
              "Morbi nulla nec dui lacus, in. Libero in pretium metus massa. Sodales dignissim vitae mauris varius faucibus. Eleifend dui, non laoreet ac luctus facilisis diam. Enim scelerisque vel at id viverra tellus.",
            rating: 4,
  ...
  return (
    <section className="qualities" id="qualities" style={{
      background:"black",
      ...
      <div className="container" style={{
        ...
        {restApidata.data[0].ourQualities.map((element) => {
          return (
            <div className="card" key={element.id}>
              ...
              />
              <p className="title" style={{ color:"white",   }}>{element.title}</p>
              <p className="description"style={{ color:"white",   }}>{element.description}</p>
            </div>
          );
        })}
      </div>
